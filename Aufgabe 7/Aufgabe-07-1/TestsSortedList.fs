module TestsSortedList

open Microsoft.VisualStudio.TestTools.UnitTesting
open FsCheck
open Mini

let empty = PriorityQueueSortedList.empty
let isEmpty = PriorityQueueSortedList.isEmpty
let insert = PriorityQueueSortedList.insert
let extractMin = PriorityQueueSortedList.extractMin
